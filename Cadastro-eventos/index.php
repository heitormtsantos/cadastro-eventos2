...
<html>
    ...
    <body>
      ...
      <form id="addevent" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Atração</label>
                                <div class="col-sm-10">
                                    <input type="text" name="atracao" class="form-control" id="atracao" placeholder="Atracao">
                                </div>
                            </div>	
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Texto</label>
                                <div class="col-sm-10">
                                    <textarea type="text" name="texto" class="form-control" id="texto" placeholder="Texto"></textarea>
                                </div>
                            </div>	
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Preço</label>
                                <div class="col-sm-10">
                                    <input type="number" format="currency" precision="2" name="preco" class="form-control" id="preco" placeholder="Preço">
                                </div>
                            </div>							
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Color</label>
